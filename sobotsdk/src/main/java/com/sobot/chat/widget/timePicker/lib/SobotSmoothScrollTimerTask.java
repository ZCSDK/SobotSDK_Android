 ...
 * @author 小嵩
 */
final class SobotSmoothScrollTimerTask extends TimerTask {
    ...
    SobotSmoothScrollTimerTask(SobotWheelView loopview, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 1) {
            ...
            loopView.handler.sendEmptyMessage(SobotMessageHandler.WHAT_ITEM_SELECTED);
        } else {
